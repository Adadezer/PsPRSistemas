...
import { Cog8ToothIcon, QuestionMarkCircleIcon } from "@heroicons/react/24/solid";
  ...
  return (
    <div className="container mx-auto p-5 py-0 h-[92px] flex justify-between items-center shadow-2xl">
      ...
      <Menu>
        ...
        <MenuList className="bg-secondary border-none text-white">
          ...
          <MenuItem className="flex items-center gap-2 bg-primary pl-4">
            <svg
              width="16"
              height="14"
              viewBox="0 0 16 14"
